export const phrasals3 = {
  ...
  across: [
    ...
    {preciseMeaning:{ 
        "случайно обнаружить": [{
            "come across" : "When I was browsing the internet, I came across an interesting article about cancer.",
            "run across": "I was surprised to run across my old friend in the bar.",
            }],
        "донести смысл": [{
            "get across": "Steve tried to get across the main idea of the text.",
            }],
        }
    }
  ],
  after: [
    ...
    {preciseMeaning:{ 
        "преследовать": [{
            "be after": "The police were after the burgular who stole the money from our house.",
  ...
  away: [
    ...
    {preciseMeaning:{ 
        увлекаться: [{
            "get carried away": "He can get carried away drawing that he forgets to have lunch.",
            }],
        "остаться безнаказанным": [{
            "get away with": "It is unbelievable with how much he could go away with.",
            }],
        ...
        "не впускать, разворачивать": [{
            "turn away": "We were turned away at the club because of the dress code.",
            }],        
        }
    }
  ],
  back: [
    ...
    {preciseMeaning:{ 
        ...
        "возвращать что-либо": [{
            ...
            "take back": "We took the jeans back to the shop. They were too long.",
            }],
        "напоминать о прошлом": [{
            ...
            "take back": "The smell of a strawberry jam took Jack back to his childhood.",  
            }],
        "размышлять повторно": [{
  ...
  by: [
    ...
    {preciseMeaning:{ 
        "посетить ненадолго": [{
            "call by": "I'll call by you this afternoon, we're going to drink some tea.",
  ...
  down: [
    ...
    {preciseMeaning:{ 
        ...
        "уменьшаться, снижаться": [{
            "bring down": "The numbers brought down in comparison to the last year.",
            }],
        болеть: [{
            "be down with": "Last week I was down with the flu, but now I'm great.",
            }],
        "сводиться к чему-либо": [{
            "come down to": "It all comes down to what you've learned at school.",
            }],  
        "слечь с болезнью": [{
        ...
        "остепениться, осесть": [{
            "settle down": "They travelled all over the world and decided to settle down and buy a flat.",
            }],   
        "записывать слова": [{
  ...
  in: [
    ...
    {preciseMeaning:{ 
        ...
        "приносить деньги": [{
            "bring in": "It's a big industry that brings in 5 billion dollars a year.",
            }],
        "входить": [{
        ...
        "просить вернуть": [{
            "call in": "The phones have been called in by Samsung to check the battery.",
            }],
        ...
        "замещать (кого-либо)": [{
            "stand in for": "The football player has been asked to stand in for them in one match.",
            }],  
  ...
  into: [
    ...
    {preciseMeaning:{ 
        ...
        "входить в силу": [{
            "come into": "The agreement has come into force and we must follow it.",
            }],
        ...
        "столкнуться с проблемой": [{
            "run into": "While looking through the research, I ran into a problem.",
            }],        
        "измениться, превратиться": [{
            "turn into": "The boys turn into men, and girls turn into women.",
            }],  
        "нести": [{
            "take into": "I took the books into the library to read them in silence.",
            }],        
        }
    }
  ],
  off: [
    ...
    {preciseMeaning:{ 
        отломиться: [{
            "break off": "A piece of the vase broke off while it was transported to our house.",
            }],
        "отменять": [{
        ...
        "сдерживать": [{
            "hold off": "He held off on buying a new car until he found a better deal. ",
            }],
        отправляться: [{
  ...
  on: [
    {mainMeaning: "Расположение одного предмета над другим или на другом, движение одного предмета в направлении другого"},
    {preciseMeaning:{ 
        "показывать (в кино)": [{
            "be on": "Let's go to the cinema, my favorite movie is on now!",
            }],
        навещать: [{
            "call on": "Me and my class called on Tom, who was badly injured last week.",
            }], 
        ...
        "набирать лишний вес": [{
            "put on": "After spending 2 weeks in Egypt, I think I put on some kilos.",
            }],
        "принятие ответсвенности": [{
            "take on": "He takes on a lot of work, more than he can take.",
            }], 
        "прием на работу": [{
            "take on": "They took Harry in because he's an expert in this field.",
            }],
        }
    }
  ],
  out: [
    ...
    {preciseMeaning:{ 
        ...
        "понимать, разбирать (слова)": [{
            "make out": "We couldn't make out what our professor said because he was too far.",
            }],
        "гаснуть": [{
            "go out": "Add some wood to the bonfire before it goes out.",
            }],
        "гасить, выключать свет": [{
            "put out": "We needed to put out the fire before leaving the forest.",
            }],
        "заканчиваться": [{
            "run out of": "We've run out of petrol on the halfway to the petrol station.",
            }],  
        ...
        "доставать": [{
            "take out": "Peter took the pen out of his bag and started writing.",
            }], 
        "оказываться": [{
            "turn out": "It turned out that we had forgotten our passports at home.",
            }],     
        }
    }
  ],
  over: [
    {mainMeaning: "Движение по поверхности, расположение предмета над другим предметом."},
    {preciseMeaning: {
        заканчиваться: [{
        ...
        понимать: [{
            "get over": "Steven couldn't get over the fact that his friend forgot his birthday.",
            }],
        "доносить (что-либо)": [{
        ...
        "захватывать, брать под свое управление": [{
            "take over": "The Communist party took over the country after the Revolution.",
            }],
        обдумывать: [{
            "think over": "Before making a decision, we must think this over.",
            }],
        "передавать": [{
            "turn over": "They didn't agree to turn over the money they have borrowed.",
            }],           
        }
    }
  ],
  round: [
    ...
    {preciseMeaning:{ 
        "приходить в себя": [{
            "bring round": "Everybody on the beach tried to bring him round after swimming in the cold ocean.",
            }],  
        посещать: [{
            "come round": "We could come round this evening to talk about recent events.",
            }],
  ...
  through: [
    {mainMeaning: "Движение с одной стороны на другую, через или сквозь предмет"},
    {preciseMeaning:{ 
        "прекращать работу или отношений": [{
            "be through with": "Peter was through with this job and wanted to quit.",
            }],  
        "поступать (звонок или денежный перевод)": [{
            "come through": "Thanks, the money came through.",
            }],
        "дозвониться, достучаться до сознания": [{
            "get through": "He hoped to get through him so he doesn't make a mistake.",
            }],  
        "успешно завершаться": [{
        ...
        "внимательно просматривать": [{
            "look through": "I was looking through the documents and found some important information.",
            }],
        "соединяться по телефону": [{
            "put through": "I'll put you through to the IT department.",
            }],  
        "растратить": [{
            "run through": "The group of friends ran through all the money in the casino.",
            }], 
        "повторить, отрепетировать": [{
            "run through": "Let's run through the scene one more time.",
            }],
        "видеть сквозь": [{
            "see through": "Jessica saw through him the first time she saw him.",
            }],       
        }
    }
  ],
  up: [
    ...
    {preciseMeaning:{ 
        ...
        "упоминать": [{
            "сome up": "This topic came up at the meeting, and we've discussed it.",
            }], 
        "предложить план или идею": [{
            "сome up with": "We came up with a plan to stop pollution in our city.",
            }], 
        "прекратить действие": [{
        ...
        "посмотреть в справочнике": [{
            "look up": "I didn't know the meaning of the word, so I looked it up.",
            }], 
        "создавать": [{
        ...
        "прикреплять": [{
            "put up": "We put up the poster on the wall so you can see some announcements.",
            }],
        "начинать (что-либо)": [{
            "set up": "We need to set up a centre for people who suffered from the tornado.",
            }],
        "отделяться": [{
            "split up": "Harry and Jessica have split up after 2 years of living together.",
            }],
