...
//   const currentMarkerIndex = useAppSelector(
//     (state) => state.player.currentMarkerIndex
//   );
...
//   const subtitlesVisible = useAppSelector(
//     (state) => state.player.subtitlesVisible
//   );
...
//   const durationSeconds = useAppSelector(
//     (state) => state.player.durationSeconds
//   );
...
//           return (
//             currentTime >= currentMarkerTime && currentTime < nextMarkerTime
//           );
//         });
...
//           isPlayMode &&
//           timeMarkers &&
//           timeMarkers.length > currentMarkerIndex + 1
//         ) {
...
//     if (!timeMarkers?.length || currentMarkerIndex < 0 || !wavesurfer.current)
//       return;
