...
export const tensesInfo = [ 
    {
        ...
        sentencesNeg:"He wasn’t very nice to me yesterday. She didn’t see the movie last week.",
    ...
    {
        name: "Future Simple", 
        useCase: "Actions that are expected in the future, predictions, offers, promises.", 
        img: futureSimpleImg, 
        grammar: "Will + Vinf", 
    ...
    },
    {
        ...
        expressions: "at 7 o'clock,  in a week, this time tomorrow, from ... till / from ... to, all day, all night "
    },
    {
        name: "Past Perfect", 
    ...
    {
        name: "Future Perfect", 
        useCase: "An event that is expected or planned to happen before a time of reference in the future", 
        img: futurePerfectImg, 
        grammar: "Will have + V3", 
        sentencesPos: "By the time she arrives at 3 pm, I will have cleaned the entire house.", 
        sentencesNeg:"She won't have cleaned the room by 5 pm tomorrow, she'll be busy.",
        sentencesQuest:"Will she have completed her Europe tour by next month?", 
        expressions: "before, till / until, by this time, by 5 p.m., in a month / year"
    },
    {
