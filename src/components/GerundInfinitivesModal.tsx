            ...
            {content.meaning1 && (
              <>
                <p className="meaning-gerinf">
                  <strong>Meaning 1:</strong> {content.meaning1}
                </p>
                <p className="example-gerinf">
                  <strong>Example 1:</strong> {content.example1}
                </p>
                <p className="meaning-gerinf">
                  <strong>Meaning 2:</strong> {content.meaning2}
                </p>
                <p className="example-gerinf">
                  <strong>Example 2:</strong> {content.example2}
                </p>
              </>
            )}
          </>
